...
class appPrincipal(eventos.Conectivos):
    ...
    def widgetsTela(self):
        self.treeLista = ttk.Treeview(self.PrincFrame, height=4, columns=('Col1', 'Col2', 'Col3', 'Col4', 'Col5', 'Col6'),  show='headings')
        self.treeLista.heading('#0', text='')
        self.treeLista.heading('#1', text='Descrição')
        self.treeLista.heading('#2', text='Fornecedor')
        self.treeLista.heading('#3', text='Qtd')
        self.treeLista.heading('#4', text='Preço')
        self.treeLista.heading('#5', text='Data')
        self.treeLista.heading('#6', text='Categoria')

        self.treeLista.column('#0', width=1, anchor='center')
        self.treeLista.column('#1', width=170, anchor='center')
        self.treeLista.column('#2', width=100, anchor='center')
        self.treeLista.column('#3', width=30, anchor='center')
        self.treeLista.column('#4', width=40, anchor='center')
        self.treeLista.column('#5', width=50, anchor='center')
        self.treeLista.column('#6', width=100, anchor='center')

        self.treeLista.place(relx=0.01, rely=0.02, relwidth=0.5, relheight=0.96)

        self.scrollLista = CTkScrollbar(self.PrincFrame, orientation='vertical', command=self.treeLista.yview)
        self.scrollLista.place(relx=0.51, rely=0.02, relheight=0.96)
        ...
        self.btn_consultar = CTkButton(self.PrincFrame, 
                                ...
                                fg_color='#FF9044',
                                hover_color='#fa7a32')
        self.btn_consultar.place(relx=0.935, rely=0.07)
        ...
        self.btn_salvar = CTkButton(self.PrincFrame, 
                                ...
                                fg_color='#FF9044',
                                hover_color='#fa7a32')
        self.btn_salvar.place(relx=0.91, rely=0.19)
        ...
        self.btn_exibir = CTkButton(self.PrincFrame, 
                                ...
                                fg_color='#FF9044',
                                hover_color='#fa7a32')
        self.btn_exibir.place(relx=0.91, rely=0.29)
        ...
        self.btn_exibirCategoria = CTkButton(self.PrincFrame, 
                                ...
                                fg_color='#FF9044',
                                hover_color='#fa7a32')
        self.btn_exibirCategoria.place(relx=0.91, rely=0.39)
        ...
        self.btn_editar = CTkButton(self.PrincFrame, 
                                ...
                                fg_color='#FF9044',
                                hover_color='#fa7a32')
        self.btn_editar.place(relx=0.91, rely=0.49)
        ...
        self.btn_excluir.place(relx=0.91, rely=0.59)
        ...
        self.btn_calendario.place(relx=0.615, rely=0.69)

        self.lbl_total = CTkLabel(self.PrincFrame, text='Total: R$', font=('Arial', 16, 'bold'), text_color='#fff')
        self.lbl_total.place(relx=0.55, rely=0.93)

        self.resTotal = CTkLabel(self.PrincFrame, 
                            text='', 
                            font=('Arial', 16, 'bold'), 
                            text_color='#fff', width=85)
        self.resTotal.place(relx=0.61, rely=0.93)
